...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://api.yokebud.com/api/contact', {
        method: 'POST',
  ...
  const buttonStyle = {
    backgroundColor: isHovering ? '#FFB700' : darkGold,
    color: '#111',
    ...
    cursor: 'pointer',
    fontWeight: '600',
    boxShadow: isHovering ? '0 8px 20px rgba(255, 215, 0, 0.4)' : '0 4px 12px rgba(255, 215, 0, 0.2)',
    ...
    >
      ...
      <main style={{ 
        ...
        <section style={sectionStyle}>
          <h1 data-aos="fade-up" style={headingStyle}>Contact Us</h1>
          <div style={cardContainerStyle}>
            ...
            >
              ...
              <p style={{ marginBottom: '1.5rem', fontSize: 'clamp(0.9rem, 2vw, 1rem)' }}>
                <strong style={{ color: gold }}>Bangladesh:</strong> Nayonpur, Shahebpara, Rajendropur Cantonment Gazipur 1742, Bangladesh
              </p>
              <p style={{ marginBottom: '1.5rem', fontSize: 'clamp(0.9rem, 2vw, 1rem)' }}>
            ...
            >
              ...
              <div style={iconContainerStyle}>
                ...
                <a href="https://www.facebook.com/yokebud" target="_blank" rel="noopener noreferrer">
                  <FaFacebook 
                    style={iconStyle} 
                    onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.2)'}
                    onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}
          ...
          <h1 data-aos="fade-up" style={headingStyle}>Get in Touch</h1>
            ...
            >
              <div style={mapContainerStyle}>
                <div style={mapTabsStyle}>
                  <button 
                    style={activeMap === 'finland' ? activeMapTabStyle : mapTabStyle}
                    onClick={() => setActiveMap('finland')}
                  >
                    Finland
                  </button>
                  <button 
                    style={activeMap === 'bangladesh' ? activeMapTabStyle : mapTabStyle}
                    onClick={() => setActiveMap('bangladesh')}
                  >
                    Bangladesh
                  </button>
                </div>
